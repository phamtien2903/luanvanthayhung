								...
								<form>
									...
									<select class="input-select">
										<option value="0">All Categories</option>
													...
													{
													?>
										<option value="1"><?php echo $value->tenloaisp;?>	</option>
                                             <?php
													} 
												?>
									</select>
			...
			<div class="container">
				...
				foreach ($loaisp as $key => $value) 
				{
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="<?php echo $value->hinh ; ?>" alt="">
							</div>
							<div class="shop-body">
								<h3><?php echo "$value->tenloaisp"; ?></h3>
									...
									{		 
										...
										<div class="product" >
											...
											<div class="product-body" >
												...
												<p class="product-category"><?php echo "$value->tensp" ?></p>
												<h3 class="product-name"><a href='<?php echo base_url(); ?>web/detail/<?php echo $value->idsp; ?>'  >detail</a></h3>
...
assets/img/sanpham/<?php echo $value->mausp ?>" alt="">
											...
											<div class="product-body">
												<h2 class="product-category"><a href="<?php echo $value->idloaisp?>"><?php echo $value->tenloaisp;?></a></h2>
					...
					<div class="row">
						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="web/product">Hot deals</a></li>
