...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="<?php echo base_url();?>admin">Start Bootstrap</a>
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      <li class="nav-item active">
       ...
       <li class="nav-item active">
        <a class="nav-link" href="<?php echo base_url();?>/web/index/">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>Logout</span>
        </a>
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="<?php echo base_url();?>assets/admin/login.html">Login</a>
          <a class="dropdown-item" href="<?php echo base_url();?>assets/admin/register.html">Register</a>
          <a class="dropdown-item" href="<?php echo base_url();?>assets/admin/forgot-password.html">Forgot Password</a>
          <div class="dropdown-divider"></div>
          <h6 class="dropdown-header">Other Pages:</h6>
          <a class="dropdown-item" href="<?php echo base_url();?>assets/admin/404.html">404 Page</a>
          <a class="dropdown-item" href="<?php echo base_url();?>assets/admin/blank.html">Blank Page</a>
        </div>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url();?>admin/loaisp">
          <i class="fas fa-fw fa-table"></i>
          <span>Quản lý Loại Sản Phẩm</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url();?>admin/nhacc">
          <i class="fas fa-fw fa-table"></i>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?php echo base_url();?>assets/admin/login.html">Logout</a>
        </div>
      </div>
    </div>
  </div>
